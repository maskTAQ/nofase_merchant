  ...
  (i.uuid = 0),
    ...
    (i.isArrayLike = function(a) {
      var b = !!a && "length" in a && a.length,
        c = i.type(a);
      return "function" === c || i.isWindow(a)
        ? !1
        : "array" === c ||
            0 === b ||
      ...
      return (
        ...
        i.slice.call(
          e.test(b)
            ...
            : f.test(b) ? c.getElementsByTagName(b) : c.querySelectorAll(b)
        )
      );
    }),
    (i.ready = function(b) {
    ...
    (i.buffer = function(a, b, c) {
      ...
      return i.extend(
        function() {
          !f || (g >= f && i.now() - g > b) || (f > g && i.now() - f > 8 * b)
            ? d()
            : (e && e.cancel(), (e = i.later(d, b, null, arguments)));
        },
        {
          stop: function() {
            e && (e.cancel(), (e = 0));
...
!(function(a, b) {
        ...
        for (
          ...
          ("A" !== d.tagName ||
            (a.each(a.targetHandles, function(a, c) {
              c.name;
              return c.hasOwnProperty("handle") && c.handle(b, d)
                ? ((e = !0), b.preventDefault(), !1)
                : void 0;
            }),
            !e));
          d = d.parentNode
  ...
  (function(a, b) {
    ...
    var c = Math.round,
      ...
      j = function(a, b) {
        return a === b
          ? ""
          : d(a) >= d(b) ? (a > 0 ? "left" : "right") : b > 0 ? "up" : "down";
      },
      k = function(a, b) {
        var c = ["pageX", "pageY"];
  ...
  (function(a) {
    ...
    (a.openWindow = function(b, c, f) {
      ...
      if (window.plus) {
        ...
        if (
          ...
          return (
            ...
            k.afterShowMethodName &&
              j.evalJS(k.afterShowMethodName + "('" + JSON.stringify(i) + "')"),
            j
          );
        if (f.createNew !== !0) {
        ...
        if (
          (l.autoShow && (h = plus.nativeUI.showWaiting(l.title, l.options)),
          ...
          b
            ? (j.addEventListener("titleUpdate", m, !1),
              j.addEventListener(
                "loaded",
                function() {
                  d(j), e(j, "pagebeforeshow", !1);
      ...
      l = a.Class.extend({
        ...
        _initParallax: function() {
          this.options.parallaxElement &&
            ...
            (this.parallaxImgStyle = this.parallaxElement.querySelector(
              "img"
            ).style));
        },
        ...
        _gotoPage: function(a) {
          ...
          for (var b = 0, c = this.snaps.length; c > b; b++)
            b === a
              ? this.snaps[b].classList.add(j)
              : this.snaps[b].classList.remove(j);
          ...
          if (
            ...
            (k > 0 || k < this.maxScrollX) &&
              (k = this.options.bounce
                ? this.x + g / 3
                : k > 0 ? 0 : this.maxScrollX),
              (l > 0 || l < this.maxScrollY) &&
                (l = this.options.bounce
                  ? this.y + h / 3
                  : l > 0 ? 0 : this.maxScrollY),
        ...
        _reInit: function() {
          for (
            var a = this.wrapper.querySelectorAll("." + e), b = 0, c = a.length;
            c > b;
            b++
          )
      ...
      l = (a.Slider = a.Scroll.extend({
        ...
        _handleSlide: function(b) {
          ...
          if (b.target === c.wrapper) {
            ...
            for (
              var e = c.scroller.querySelectorAll(j),
                f = [],
                g = 0,
                h = e.length;
              h > g;
            ...
            if (m) {
              m.getAttribute("data-scroll") &&
                a(m)
                  .scroll()
                  .gotoPage(d.slideNumber);
              ...
              if (n.length > 0)
                ...
                if (o) o.innerText = d.slideNumber + 1;
                  ...
                  for (
                    var p = m.querySelectorAll(".mui-control-item"),
                      g = 0,
                      h = p.length;
                    h > g;
                    g++
        ...
        _handleIndicatorTap: function(a) {
          ...
          (c.classList.contains(f) || c.classList.contains(g)) &&
            (b[c.classList.contains(f) ? "prevItem" : "nextItem"](),
            a.stopPropagation());
        },
          ...
          return (
            this.loop &&
              (b =
                0 === a.pageX
                  ? this.itemLength - 3
                  : a.pageX === this.itemLength - 1 ? 0 : a.pageX - 1),
            b
          );
        },
        _reLayout: function() {
        ...
        gotoItem: function(a, b) {
          this._gotoItem(
            a,
            "undefined" == typeof b ? this.options.scrollTime : b
          );
        },
        nextItem: function() {
                  ...
                  a.plusReady(function() {
                    ...
                    if (a) {
                      ...
                      a.addEventListener("close", function() {
                        var a =
                          b.options.webviewId &&
                          b.options.webviewId.replace(/\//g, "_");
              ...
              a.extend(
                {
                    ...
                    a.plusReady(
                      function() {
                        plus.webview
                          .currentWebview()
                          .setBounce({
                            offset: { top: this.options.down.height + "px" }
                          });
                      }.bind(this)
                    );
                  },
                  ...
                  endPullupToRefresh: function(a) {
                    var c = this;
                    c.pullLoading &&
                      (c.pullLoading.classList.remove(d),
                      c.pullLoading.classList.add(e),
                      (c.isLoading = !1),
                      a
                        ? ((c.finished = !0),
                          (c.pullCaption.className = g + " " + j),
                          (c.pullCaption.innerHTML =
                            c.options.up.contentnomore),
                          b.removeEventListener("plusscrollbottom", c),
                          window.removeEventListener("dragup", c))
                        : ((c.pullCaption.className = g + " " + h),
                          (c.pullCaption.innerHTML =
                            c.options.up.contentdown)));
                  },
                  disablePullupToRefresh: function() {
                    this._initPullupRefresh(),
                      (this.bottomPocket.className =
                        "mui-pull-bottom-pocket " + e),
          ...
          a.fn.pullRefresh = function(d) {
            ...
            return i || "undefined" != typeof f
              ? (i
                ...
                d.down && d.down.auto
                  ? g._pulldownLoading()
                  : d.up && d.up.auto && g.pullupLoading(),
                g)
              : !1;
          };
        }
          ...
          switch (b.type) {
            ...
            case "drag":
              ...
              this.startX
                ...
                : ((this.startX = c.center.x), (this.lastX = this.startX)),
                !this.isDragging &&
                    ...
                    ((e =
                      f >= 0
                        ? (this.offCanvasRightWidth &&
                            f / this.offCanvasRightWidth) ||
                          0
                        : (this.offCanvasLeftWidth &&
                            f / this.offCanvasLeftWidth) ||
                          0),
                    "right" === d && 0 >= e && (e >= -0.5 || c.swipe)
                      ...
                      : "right" === d && e > 0 && (e >= 0.5 || c.swipe)
                        ...
                        : "right" === d && -0.5 >= e
                          ...
                          : "right" === d && e > 0 && 0.5 >= e
                            ? this.openPercentage(-100)
                            : "left" === d && e >= 0 && (0.5 >= e || c.swipe)
                              ? this.openPercentage(-100)
                              : "left" === d && 0 > e && (-0.5 >= e || c.swipe)
                                ? this.openPercentage(0)
                                : "left" === d && e >= 0.5
                                  ? this.openPercentage(0)
                                  : "left" === d && e >= -0.5 && 0 > e
          ...
          for (var d = b.target; d && d !== c; d = d.parentNode)
            if (
              ...
              b.detail && b.detail.gesture && b.detail.gesture.preventDefault(),
                a(a.targets._container)
                  .offCanvas()
                  .toggle(a.targets.offcanvas),
      ...
      s = (function() {
        ...
        return (
          ...
          b.addEventListener("tap", function(b) {
            ...
            d &&
              (d.addEventListener("webkitTransitionEnd", r),
  ...
  (function(a, b, c, d, e) {
    var f = "mui-control-item",
      ...
      l = function(a, b) {
        return b.classList &&
          (b.classList.contains(f) || b.classList.contains(k))
          ? ((b.parentNode &&
              b.parentNode.classList &&
              b.parentNode.classList.contains(h)) ||
              a.preventDefault(),
            b)
          : !1;
      };
    a.registerTarget({ name: d, index: 80, handle: l, target: !1 }),
      b.addEventListener("tap", function(b) {
        var e = a.targets.tab;
        if (e) {
          for (
            var h, l, m, n = "mui-active", o = "." + n, p = e.parentNode;
            p && p !== c;
            p = p.parentNode
          ) {
          ...
          if (
            ...
            if (!q) {
              ...
              m.classList.add(n);
              for (
                var u = [], v = r.querySelectorAll("." + i), s = 0;
                s < v.length;
                s++
              )
  ...
  (function(a, b, c) {
    ...
    var e,
      ...
      C = function(a) {
        a
          ? f ? f.classList.add(g) : e && e.classList.add(g)
          : (B && B.cancel(),
        ...
        if (d && !d.classList.contains(f)) {
          ...
          if (e) {
            ...
            (g.webkitTransform = "translate3d(" + (-100 + b) + "%,0,0)"),
              "undefined" != typeof c
                ? (g.webkitTransitionDuration = c + "ms")
                : (g.webkitTransitionDuration = "");
          }
          return d;
        }
      };
      ...
      t = function(a, b) {
        (this.element = a),
          ...
          ~this.options.actions.indexOf("slider")
            ? ((this.sliderActionClass = k + " " + l),
              (this.sliderActionSelector = r))
            : (~this.options.actions.indexOf("clear") &&
                ((this.clearActionClass = d + " " + e + " " + l),
              ...
              ~this.options.actions.indexOf("search") &&
                ((this.searchActionClass = j), (this.searchActionSelector = q)),
              ~this.options.actions.indexOf("password") &&
                ((this.passwordActionClass = d + " " + h),
        ...
        return (
          this.each(function() {
            ...
            if (g) b = a.data[g];
              ...
              (g = ++a.uuid),
                (b = a.data[g] = new t(this, { actions: d.join(",") }));
    ...
    (e.prototype.initEvent = function() {
      ...
      (e.prototype.handleScroll = function() {
        this._style.backgroundColor =
          ...
          this._B +
          "," +
          (b.scrollY - this.options.top) / this.options.offset +
          ")";
      }),
      ...
      h = function(b, c) {
        (this.element = b),
          ...
          this.options.loadingText ||
            (this.options.loadingText = g.loadingText),
